...
const tagPillVariants = cva("rounded-full px-3 py-1 font-semibold tabular-nums", {
  variants: {
    tone: {
      danger: "bg-latte-red/15 text-latte-red-text text-[10px] uppercase tracking-[0.3em]",
