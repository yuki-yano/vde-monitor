...
const iconButtonVariants = cva(
  "relative inline-flex items-center justify-center rounded-full border transition active:scale-[0.96] after:absolute after:-inset-0.5 after:content-[''] focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-latte-lavender disabled:pointer-events-none disabled:opacity-60 disabled:cursor-not-allowed",
  {
    variants: {
      variant: {
        base: "border-latte-surface2 bg-latte-base/80 text-latte-text hover:border-latte-lavender/60 hover:text-latte-lavender-text shadow-elev-3 backdrop-blur-sm",
        lavender:
