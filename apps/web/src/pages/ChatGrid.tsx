    ...
    return (
      <>
        ...
        <main className="flex min-h-screen items-center justify-center p-4">
          <div className="max-w-md space-y-3 rounded-2xl border border-[var(--material-stroke)] bg-[var(--material-canvas)] p-5 text-center shadow-[var(--material-shadow)] backdrop-blur-2xl">
